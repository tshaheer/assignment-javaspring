...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
     * Handles StatementSearchException. Created to encapsulate errors in statement search.
     *
     * @param ex the StatementSearchException
     * @return the ApiErrorResponse object
     */
    @ExceptionHandler({ StatementSearchException.class })
    public ResponseEntity<Object> handleStatementSearchException(final StatementSearchException ex, final WebRequest request) {
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(final MethodArgumentTypeMismatchException ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        //
        if(ex.getRequiredType() != null &&  ex.getRequiredType().getName() == "java.math.BigDecimal") {
            final ApiErrorResponse apiError = new ApiErrorResponse(HttpStatus.BAD_REQUEST, "Invalid format", ex.getName() + " is not a Number");
            return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
        }
    ...
    public ResponseEntity<Object> handleAuthenticationException(final AuthenticationException ex, final WebRequest request) {
        final ApiErrorResponse apiError = new ApiErrorResponse(HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), new ArrayList<>());
        return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
    }
